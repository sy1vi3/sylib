    ...
    */
    class Addrled : private Device{
        ...
        public:
            ...
            *
            * \param end_pixel
            *        The pixel number to end the pulse on. If this unset it defaults to the end of the strip
            */ 
            ...
            */ 
            ...
            /**
            * \brief Automatically rotates the colors of a provided buffer through the light strip periodically
            *
