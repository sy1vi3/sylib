    ...
    */
    class ProportionalController{
        ...
        public:
            ...
            *        A flag that when true shifts the P controller to using kP2 as the kP constant when error is less than <maxRange> 
            *
            * \param kP2
            *        The secondary kP value that is used when maxRangeEnabled is on and the error is within maxRange
            *
            * \param maxRange
            ...
            */
            ...
            /**
            * \brief Sets the error range from the target value that is used for switching between kP and kP2
            *
            * \param range
            *        Max error value
            */
    ...
    */
    struct SpeedControllerInfo {
        ...
        */
        ...
        /**
        * \brief Negative range from target below which the applied voltage is multiplied by the coast-down modifier
        */
        ...
        */
        ...
        SpeedControllerInfo(kv_fn_t kV = [](double rpm){return 0;}, double kP = 0, double kI = 0, double kD = 0, double kH = 0, 
                            bool antiWindupEnabled = false, double antiWindupRange = 0, bool pRangeEnabled = false, double pRange = 0,
                            double kP2 = 0, double maxVoltageRange = 0, bool coastDownEnabled = false, double coastDownRange = 0, double coastDownModifier = 1) :
                            kV(kV), kP(kP), kI(kI), kD(kD), kH(kH), antiWindupEnabled(antiWindupEnabled), antiWindupRange(antiWindupRange),
                            pRangeEnabled(pRangeEnabled), pRange(pRange), kP2(kP2), maxVoltageRange(maxVoltageRange), coastDownEnabled(coastDownEnabled),
                            coastDownRange(coastDownRange), coastDownModifier(coastDownModifier){}
    };
