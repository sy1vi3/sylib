 ...
 *
 * \brief Contains prototypes for functions relating to sylib's background processes
 */
...
namespace sylib {
    ...
    *
    * This is a wrapper for pros::Task::delay_until() if running in a PROS enviroment,
    * and a wrapper for vex::this_thread::sleep_until() if in a VEXcode enviroment
    *
    * \param prev_time
    ...
    */
    class SylibDaemon{
        ...
        public:
            ...
            * or creates it if it doesn't exist yet
            *
            * Doesn't lock the mutex. This is used when creating objects in a global scope,
            * before RTOS stuff has initialized and mutexes work.
            *
            * \return SylibDaemon object
            */
            ...
            /**
            * \brief The sole function that runs inside a task made specifically for the 
            * Sylib daemon. Contains an infinite loop that will prevent anything else from
            * happening in the thread this is called in.
            *
            * \return Theoretically 1, but this function should never return on account of the while(1) loop
            */
            static int managerTaskFunction();

            /**
            * \brief Adds a Device object or one of its child classes to the daemon's list
            ...
            */
            ...
            /**
            * \brief Removes a Device object or one of its child classes from the daemon's list
            * of objects which need periodic updating
            *
            * \param objectPointerToSchedule
            *        A pointer to a Device object
    ...
    */
    class Device  {
        ...
        public:
            ...
            *
            * \param interval
            *        The number of frames to wait between updates. A frame is 2ms, so this
            * value multiplied by 2 is the approximate time between updates. It can be off by +/- 1ms
            *
            * \param offset
            *        The number of frames to shift the excecution of the update function
            */
            ...
            */
            ...
            /**
            * \brief Sets the number of frames to shift the excecution of the update function
            *
            * \param interval
            *        Sylib frame count
            */
